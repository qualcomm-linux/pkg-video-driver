...
#include <dt-bindings/clock/qcom,gcc-glymur.h>
#include <dt-bindings/clock/qcom,videocc-glymur.h>
...
static struct msm_vidc_ubwc_config_data ubwc_config_glymur[] = {
...
/* name, llcc_id */
static const struct subcache_table glymur_subcache_table[] = {
	{ "vidsc0",     LLCC_VIDSC0 },
	{ "vidvsp",     LLCC_VIDVSP },
};
...
static const struct device_region_table glymur_device_region_table[] = {
	{
		"aon-registers",
...
static const u32 glymur_vdec_psc_mpeg2[] = {
	HFI_PROP_BITSTREAM_RESOLUTION,
	HFI_PROP_CROP_OFFSETS,
	HFI_PROP_LUMA_CHROMA_BIT_DEPTH,
	HFI_PROP_CODED_FRAMES,
...
static const u32 glymur_vdec_input_properties_mpeg2[] = {
	HFI_PROP_NO_OUTPUT,
	HFI_PROP_SUBFRAME_INPUT,
};
...
static const u32 glymur_vdec_output_properties_mpeg2[] = {
	HFI_PROP_WORST_COMPRESSION_RATIO,
	HFI_PROP_WORST_COMPLEXITY_FACTOR,
	HFI_PROP_PICTURE_TYPE,
	HFI_PROP_DPB_LIST,
...
static const struct msm_vidc_platform_data glymur_data = {
	...
	.subcache_tbl = glymur_subcache_table,
	.subcache_tbl_size = ARRAY_SIZE(glymur_subcache_table),
	...
	.dev_reg_tbl = glymur_device_region_table,
	.dev_reg_tbl_size = ARRAY_SIZE(glymur_device_region_table),
	.clock_source_scaling_ratio = 3,
	.fwname = "vpu36_p4_s7.mbn",
	.num_cores = 2,
	.pas_id = 9,
	.supports_mmrm = 1,
	...
	.ubwc_config = ubwc_config_glymur,
	...
	.psc_mpeg2_tbl = glymur_vdec_psc_mpeg2,
	.psc_mpeg2_tbl_size = ARRAY_SIZE(glymur_vdec_psc_mpeg2),
	...
	.dec_input_prop_mpeg2 = glymur_vdec_input_properties_mpeg2,
	...
	.dec_input_prop_size_mpeg2 = ARRAY_SIZE(glymur_vdec_input_properties_mpeg2),
	...
	.dec_output_prop_mpeg2 = glymur_vdec_output_properties_mpeg2,
	...
	.dec_output_prop_size_mpeg2 = ARRAY_SIZE(glymur_vdec_output_properties_mpeg2),
